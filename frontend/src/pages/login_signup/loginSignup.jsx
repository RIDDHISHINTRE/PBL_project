      ...
      <div className="form-container">
        ...
        {islogin ? (
          ...
          <form className="form" onSubmit={handleAlumniSignup}>
            ...
            <input type="text" placeholder="Company Name" onChange={(e) => setAlumniSignupData({ ...alumniSignupData, companyName: e.target.value })} required />
            <input type="text" placeholder="College ID" onChange={(e) => setAlumniSignupData({ ...alumniSignupData, collegeid: e.target.value })} required />
            <select defaultValue="" onChange={(e) => setAlumniSignupData({ ...alumniSignupData, role: e.target.value })} required>
            ...
            {alumniSignupData.role === "Other" && (
              <input type="text" placeholder="Enter your role" onChange={(e) => setAlumniSignupData({ ...alumniSignupData, otherRole: e.target.value })} required />
            )}
            <button type="submit">Sign Up</button>
          </form>
        )}
