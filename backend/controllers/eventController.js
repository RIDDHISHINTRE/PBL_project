...
// exports.deleteEvent = async (req, res) => {
//     console.log("Decoded User:", req.user); // ✅ Check if collegeid is included

//     try {
//         const { id } = req.params;
//         const userCollegeId = req.user.collegeid; // ✅ Use collegeid
...
//         console.log("Logged-in user college ID:", userCollegeId);

//         if (event.createdBy !== userCollegeId) {
//             return res.status(403).json({ message: "Not authorized to delete this event" });
//         }
